 ...
 *          DO NOT MODIFY THIS FILE, MODIFY src/sans/models/include/GelFit.h
...
static PyObject * CGelFitModelError = NULL;
...
static void
CGelFitModel_dealloc(CGelFitModel* self)
{
...
static PyObject *
CGelFitModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CGelFitModel *self;
    
    self = (CGelFitModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CGelFitModel_init(CGelFitModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
	...
	self->model = new GelFitModel();

        // Initialize parameter dictionary
        PyDict_SetItemString(self->params,"scale",Py_BuildValue("d",2.000000000000));
        PyDict_SetItemString(self->params,"gScale",Py_BuildValue("d",1.700000000000));
        PyDict_SetItemString(self->params,"radius",Py_BuildValue("d",104.000000000000));
        PyDict_SetItemString(self->params,"background",Py_BuildValue("d",0.010000000000));
        PyDict_SetItemString(self->params,"zeta",Py_BuildValue("d",16.000000000000));
        PyDict_SetItemString(self->params,"lScale",Py_BuildValue("d",3.500000000000));
...
static PyMemberDef CGelFitModel_members[] = {
    {name_params, T_OBJECT, offsetof(CGelFitModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CGelFitModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CGelFitModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CGelFitModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(GelFitModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( GelFitModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CGelFitModelError, 
                   "CGelFitModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CGelFitModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
    ...
    self->model->gScale = PyFloat_AsDouble( PyDict_GetItemString(self->params, "gScale") );
    self->model->radius = PyFloat_AsDouble( PyDict_GetItemString(self->params, "radius") );
    self->model->background = PyFloat_AsDouble( PyDict_GetItemString(self->params, "background") );
    self->model->zeta = PyFloat_AsDouble( PyDict_GetItemString(self->params, "zeta") );
    self->model->lScale = PyFloat_AsDouble( PyDict_GetItemString(self->params, "lScale") );

	
	// Get input and determine whether we have to supply a 1D or 2D return value.
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CGelFitModelError, 
	    	"CGelFitModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CGelFitModelError, 
                   "CGelFitModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CGelFitModelError, 
	    		"CGelFitModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CGelFitModelError, 
                   "CGelFitModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CGelFitModelError, 
                   "CGelFitModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CGelFitModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CGelFitModelError, 
	    	"CGelFitModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CGelFitModelError, 
	    		"CGelFitModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CGelFitModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CGelFitModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CGelFitModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CGelFitModel *self) {
 ...
 */
static PyObject * calculate_VR(CGelFitModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CGelFitModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CGelFitModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CGelFitModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CGelFitModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CGelFitModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CGelFitModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CGelFitModelError,
	    	"CGelFitModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
 ...
 {
	    PyErr_SetString(CGelFitModelError,
	    	"CGelFitModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CGelFitModel_methods[] = {
...
static PyTypeObject CGelFitModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CGelFitModel",             /*tp_name*/
    sizeof(CGelFitModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CGelFitModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CGelFitModel_methods,             /* tp_methods */
    CGelFitModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CGelFitModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CGelFitModel_new,                 /* tp_new */
};
...
void addCGelFitModel(PyObject *module) {
    ...
    if (PyType_Ready(&CGelFitModelType) < 0)
        return;

    Py_INCREF(&CGelFitModelType);
    PyModule_AddObject(module, "CGelFitModel", (PyObject *)&CGelFitModelType);
    
    d = PyModule_GetDict(module);
    static char error_name[] = "CGelFitModel.error";
    CGelFitModelError = PyErr_NewException(error_name, NULL, NULL);
    PyDict_SetItemString(d, "CGelFitModelError", CGelFitModelError);
}
