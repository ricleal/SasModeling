 ...
 *          DO NOT MODIFY THIS FILE, MODIFY src/sans/models/include/cylinder.h
...
CCylinderModel_init(CCylinderModel *self, PyObject *args, PyObject *kwds)
{
	...
	self->model = new CylinderModel();
        ...
        PyDict_SetItemString(self->params,"M0_sld_cyl",Py_BuildValue("d",0.000000000000));
        ...
        PyDict_SetItemString(self->params,"M_theta_cyl",Py_BuildValue("d",0.000000000000));
        ...
        PyDict_SetItemString(self->params,"M_phi_cyl",Py_BuildValue("d",0.000000000000));
...
static PyObject * evalDistribution(CCylinderModel *self, PyObject *args){
    ...
    self->model->M0_sld_cyl = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M0_sld_cyl") );
    ...
    self->model->M_theta_cyl = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_theta_cyl") );
    ...
    self->model->M_phi_cyl = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_phi_cyl") );
