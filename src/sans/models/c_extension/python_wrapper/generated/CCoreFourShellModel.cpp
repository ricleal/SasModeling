 ...
 *          DO NOT MODIFY THIS FILE, MODIFY src/sans/models/include/corefourshell.h
...
CCoreFourShellModel_init(CCoreFourShellModel *self, PyObject *args, PyObject *kwds)
{
	...
	self->model = new CoreFourShellModel();
        ...
        PyDict_SetItemString(self->params,"M_phi_core0",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M_phi_solv",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M0_sld_core0",Py_BuildValue("d",0.000000000000));
        ...
        PyDict_SetItemString(self->params,"M_theta_core0",Py_BuildValue("d",0.000000000000));
        ...
        PyDict_SetItemString(self->params,"M_theta_shell3",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M_theta_shell2",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M_theta_shell1",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"sld_solv",Py_BuildValue("d",0.000006400000));
        PyDict_SetItemString(self->params,"M_theta_shell4",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M_phi_shell2",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M_phi_shell3",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M_phi_shell1",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M_phi_shell4",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M0_sld_shell4",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M0_sld_shell3",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M0_sld_shell2",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M0_sld_shell1",Py_BuildValue("d",0.000000000000));
...
static PyObject * evalDistribution(CCoreFourShellModel *self, PyObject *args){
    ...
    self->model->M_phi_core0 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_phi_core0") );
    self->model->M_phi_solv = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_phi_solv") );
    self->model->M0_sld_core0 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M0_sld_core0") );
    ...
    self->model->M_theta_core0 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_theta_core0") );
    self->model->background = PyFloat_AsDouble( PyDict_GetItemString(self->params, "background") );
    self->model->M0_sld_solv = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M0_sld_solv") );
    self->model->M_theta_shell3 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_theta_shell3") );
    self->model->M_theta_shell2 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_theta_shell2") );
    self->model->M_theta_shell1 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_theta_shell1") );
    self->model->sld_solv = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_solv") );
    self->model->M_theta_shell4 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_theta_shell4") );
    self->model->M_phi_shell2 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_phi_shell2") );
    self->model->M_phi_shell3 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_phi_shell3") );
    self->model->M_phi_shell1 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_phi_shell1") );
    self->model->M_phi_shell4 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_phi_shell4") );
    self->model->M0_sld_shell4 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M0_sld_shell4") );
    self->model->M0_sld_shell3 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M0_sld_shell3") );
    self->model->M0_sld_shell2 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M0_sld_shell2") );
    self->model->M0_sld_shell1 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M0_sld_shell1") );
