 ...
 *          DO NOT MODIFY THIS FILE, MODIFY src/sans/models/include/core_shell.h
...
CCoreShellModel_init(CCoreShellModel *self, PyObject *args, PyObject *kwds)
{
	...
	self->model = new CoreShellModel();
        ...
        PyDict_SetItemString(self->params,"M_phi_shell",Py_BuildValue("d",0.000000000000));
        ...
        PyDict_SetItemString(self->params,"M_theta_core",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M0_sld_shell",Py_BuildValue("d",0.000000000000));
        ...
        PyDict_SetItemString(self->params,"M0_sld_core",Py_BuildValue("d",0.000000000000));
        ...
        PyDict_SetItemString(self->params,"M_theta_shell",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"M_phi_core",Py_BuildValue("d",0.000000000000));
...
static PyObject * evalDistribution(CCoreShellModel *self, PyObject *args){
    ...
    self->model->M_phi_shell = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_phi_shell") );
    ...
    self->model->M_theta_core = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_theta_core") );
    self->model->M0_sld_shell = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M0_sld_shell") );
    ...
    self->model->M0_sld_core = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M0_sld_core") );
    ...
    self->model->M_theta_shell = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_theta_shell") );
    self->model->M_phi_core = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_phi_core") );
