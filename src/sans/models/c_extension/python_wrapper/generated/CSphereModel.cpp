 ...
 *          DO NOT MODIFY THIS FILE, MODIFY src/sans/models/include/sphere.h
...
CSphereModel_init(CSphereModel *self, PyObject *args, PyObject *kwds)
{
	...
	self->model = new SphereModel();
        ...
        PyDict_SetItemString(self->params,"M_phi_sph",Py_BuildValue("d",0.000000000000));
        ...
        PyDict_SetItemString(self->params,"M0_sld_sph",Py_BuildValue("d",0.000000000000));
        ...
        PyDict_SetItemString(self->params,"M_theta_sph",Py_BuildValue("d",0.000000000000));
...
static PyObject * evalDistribution(CSphereModel *self, PyObject *args){
    ...
    self->model->M_phi_sph = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_phi_sph") );
    ...
    self->model->M0_sld_sph = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M0_sld_sph") );
    ...
    self->model->M_theta_sph = PyFloat_AsDouble( PyDict_GetItemString(self->params, "M_theta_sph") );
